...
class CreateHospconswrkTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lmr_hospital_consults_wrk_day', function (Blueprint $table) {
            ...
            $table->foreign('consulting_id')->references('id')->on('lmr_hospital_consultants')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('lmr_hospital_consults_wrk_day');
    }
}
