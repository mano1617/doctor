...
@section('title', app_name() . ' | Diagnostic Center | Edit' )
    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <strong>Edit Diagnostic Center</strong>
                <a href="{{ route('admin.diagnostic-center.index') }}" class="btn btn-danger float-right">
                    <i class="fa fa-fw fa-close"></i>Cancel
                </a>
            </div>
        <form id="createPhysician" class="form-horizontal" enctype="multipart/form-data" method="post" action="{{ route('admin.diagnostic-center.update',$data->id) }}">
            {{csrf_field()}}
            {{ method_field('PUT') }}
            ...
            <div class="card-body">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="">Name of Diagnostic Center<sup class="text-danger">*</sup></label>
             ...
             <div class="card-footer text-right">
                ...
                <a href="{{ route('admin.diagnostic-center.index') }}" class="btn btn-danger"><i class="fa fa-fw fa-close"></i>Cancel</a>
            </div>
                </form>
        </div><!--card-->
    </div><!--col-->
