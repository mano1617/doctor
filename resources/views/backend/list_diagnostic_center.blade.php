...
@section('title', app_name() . ' | Diagnostic Center')
        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <strong>Diagnostic Center Lists</strong>
                    <div class="float-right">
                    <a href="{{ route('admin.diagnostic-center.create') }}" class="btn btn-outline-success"><i class="fa fa-fw fa-plus"></i>CREATE</a>
                    </div>
                </div><!--card-header-->
                <div class="card-body">
...
$(function() {
    ...
    $('#userTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.diagnostic-center.index') }}",
        columns: [
    ...
    $("body").on('click', '.editGalRow', function(e)
    {
        ...
        $("#editGallery").attr('action',"{{ route('admin.diagnostic-center.galleries.index') }}/"+$(this).data('row'));

        $.ajax({
            method : 'get',
            url : "{{ route('admin.diagnostic-center.galleries.index') }}/"+$(this).data('row'),
    ...
    $("body").on('click', '.viewGallery', function(e)
    {
        ...
        $.ajax({
            type : 'post',
            url : "{{ route('admin.diagnostic-center.listGalleries') }}",
    ...
    var editGallery = $("#editGallery").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                method : 'post',
                url : "{{ route('admin.diagnostic-center.galleries.index') }}/"+$("#erow").val(),
                data : formData,
                dataType:'json',
                cache: false,
                contentType: false,
    ...
    var createGallery = $("#createGallery").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                method : 'post',
                url : "{{ route('admin.diagnostic-center.galleries.store') }}",
                data : formData,
                dataType:'json',
                cache: false,
                contentType: false,
