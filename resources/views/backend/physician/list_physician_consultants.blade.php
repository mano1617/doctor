                    ...
                    <div class="tab-pane fade @if($ck==0) active show @endif" id="show_{{ $cval->id }}" role="tabpanel" aria-labelledby="list_show_{{ $cval->id }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <a id="list_show_{{ $cval->id }}" data-id="show_{{ $cval->id }}" data-clinic="{{ $cval->clinic_id }}" href="javascript:void(0);" data-rowurl="{{route('admin.physician.consultants.updateStatus', [$cval->id, 2])}}" data-row="{{$cval->id}}" class="btn removeRow btn-outline-danger"><i class="fa fa-fw fa-trash"></i></a>
                            </div>
                        </div>
