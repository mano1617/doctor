<div class="card">
    <div class="card-header">{{ $data->name }}<small> Total {{ count($branches).' Branch'.(count($branches)>1 ? 's' : '') }} are available.</small>
        <div class="float-right">
            <a href="{{ route('admin.diagnostic-center.create',['parent' => $data->id]) }}" data-clinic="{{ $data->id }}" class="btn btn-outline-success"><i class="fa fa-fw fa-plus"></i>CREATE</a>
                    ...
                    <div class="tab-pane fade @if($ck==0) active show @endif" id="show_{{ $cval->id }}" role="tabpanel" aria-labelledby="list_show_{{ $cval->id }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <a href="{{ route('admin.diagnostic-center.edit',$cval->id) }}" data-row="{{$cval->id}}" class="btn btn-outline-info editRow"><i class="fa fa-fw fa-pencil"></i></a>
