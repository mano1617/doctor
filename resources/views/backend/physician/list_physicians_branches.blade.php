...
@section('title', app_name() . ' | Users | Physicians | Branches')
            ...
            <div class="modal fade" id="add_consults" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form id="createConsultant" enctype="multipart/form-data" method="post" action="">
                    {{csrf_field()}}
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cli_cons_doc_name" id="add_cli_cons_doc_name" class="form-control">
